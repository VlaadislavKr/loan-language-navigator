...
/**
 * Страница кредитных предложений для русскоязычной версии Эстонии
 * Оптимизирована для server-side rendering
 */
const RussianEstonianCredits = () => {
                ...
                <CardContent className="flex-grow">
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{offer.minTerm} - {offer.maxTerm} {currentLocale === 'ru' ? 'мес.' : 'months'}</span>
                    </div>
                    <div className="flex justify-between">
...
export default RussianEstonianCredits;
