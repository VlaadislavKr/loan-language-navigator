...
/**
 * Главная страница эстонской версии сайта
      ...
      <section id="loans" className="py-12 bg-slate-50 dark:bg-slate-900">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center">
            ...
            <Link to="/et/laenud" className="inline-flex items-center justify-center rounded-md bg-primary px-6 py-3 text-lg font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90">
